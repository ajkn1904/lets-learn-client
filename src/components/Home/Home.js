...
const Home = () => {
    return (
        <>
            <div className="hero min-h-[90vh] bg-cover" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1599666520394-50d845fe09c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")` }}>
