    ...
    return (
        <div className="flex">
            ...
            <div className='grow' style={{ marginLeft: "15px", marginBottom: "50px" }}>
                ...
                <div className='md:w-9/12 lg:w-9/12 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 sm:mx-10 md:mx-auto lg:mx-auto'>
                    {courses.map(course => <CourseCards course={course} key={course.id}></CourseCards>)
                    }
                </div>
            </div>
            {/* side nav of courses page */}
            <div className="bg-blue-50 ml-4">
